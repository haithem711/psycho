...
import "./step-professional-information.scss";
const { Title } = Typography;
class StepPersonnalInformations extends React.Component {
  state = {
   value: [],
  };
  handleSubmit = e => {
...
const StepPersonnalInformation = Form.create({ name: 'signup-form3' })(StepPersonnalInformations);
...
export default connect(mapStateToProps)(StepPersonnalInformation)